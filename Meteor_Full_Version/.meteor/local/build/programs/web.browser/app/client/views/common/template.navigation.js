...
Template["navigation"] = new Template("Template.navigation", (function() {
  ...
  return HTML.NAV({
  ...
  }, HTML.Raw('<i class="fa fa-diamond"></i>'), " ", HTML.Raw('<span class="nav-label">Layouts</span>'), " ", HTML.Raw('<span class="label label-primary pull-right">NEW</span>')), "\n                "), "\n                ", HTML.LI({
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "graphFlot|graphMorris|graphRickshaw|graphChartJs|graphPeity|graphSparkline"
      }));
    }
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "contacts|profile|projects|projectDetail|teamsBoard|clients|fullHeight|fileManager|calendar|issueTracker|blog|article|faq|timelineOne|pinBoard"
      }));
    }
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "toastrNotification|nestableList|agileBoard|timelineTwo|diff|idleTimer|spinners|liveFavicon|googleMaps|codeEditor|modalWindow|forumView|validation|treeView|chatView"
      }));
    }
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "typography|icons|draggablePanels|buttons|video|tabsPanels|notifications|badgesLabels"
      }));
    }
    ...
    "class": function() {
      return Spacebars.mustache(view.lookup("isActiveRoute"), Spacebars.kw({
        regex: "tableStatic|dataTables|jqGrid"
      }));
    }
  ...
  }, HTML.Raw('<i class="fa fa-database"></i>'), " ", HTML.Raw('<span class="nav-label">Collections</span>')), "\n                "), "\n            "), "\n\n        "), "\n    ");
}));
